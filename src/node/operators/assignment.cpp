...
// Power assignment:
PowerAssignment::PowerAssignment(NodePointer&& t_left,
                                 NodePointer&& t_right)
...
auto PowerAssignment::accept([[maybe_unused]] NodeVisitor t_visitor)
  -> void
{
  //
}
...
auto MultiplyAssignment::accept([[maybe_unused]] NodeVisitor t_visitor)
  -> void
{
  //
}
...
// Divide assignment:
DivideAssignment::DivideAssignment(NodePointer&& t_left,
                                   NodePointer&& t_right)
  : BinaryOperator{Precedence::Assignment, Associativity::RIGHT,
                   std::forward<NodePointer>(t_left),
                   std::forward<NodePointer>(t_right)}
...
auto DivideAssignment::accept([[maybe_unused]] NodeVisitor t_visitor)
  -> void
{
  //
}
...
// Modulo assignment:
ModuloAssignment::ModuloAssignment(NodePointer&& t_left,
                                   NodePointer&& t_right)
  : BinaryOperator{Precedence::Assignment, Associativity::RIGHT,
                   std::forward<NodePointer>(t_left),
                   std::forward<NodePointer>(t_right)}
...
auto ModuloAssignment::accept([[maybe_unused]] NodeVisitor t_visitor)
  -> void
{
  //
}
...
// Add assignment:
AddAssignment::AddAssignment(NodePointer&& t_left,
                             NodePointer&& t_right)
  : BinaryOperator{Precedence::Assignment, Associativity::RIGHT,
                   std::forward<NodePointer>(t_left),
                   std::forward<NodePointer>(t_right)}
...
auto SubtractAssignment::accept([[maybe_unused]] NodeVisitor t_visitor)
  -> void
{
  //
}
